...
impl ToJSON for ChannelKind {
    fn to_json(&self, parts: &mut BinaryParts) -> JSON {
        ...
        match *self {
            ...
            LightOn => "LightOn".to_json(parts),
            OpenClosed => "OpenClosed".to_json(parts),
	        DoorLocked => "DoorLocked".to_json(parts),
            Username => "Username".to_json(parts),
            Password => "Password".to_json(parts),
            countEveryInterval => "CountEveryInterval".to_json(parts),
            ...
            ThinkerbellRuleOn => "ThinkerbellRuleOn".to_json(parts),
            TakeSnapshot => "TakeSnapshot".to_json(parts),
            Log => "Log".to_json(parts),
            WebPushNotify => "WebPushNotify".to_json(parts),
...
impl ChannelKind {
    ...
    pub fn get_type(&self) -> Type {
        ...
        match *self {
            ...
            CurrentTimeOfDay | RemainingTime | CountEveryInterval => Type::Duration,
